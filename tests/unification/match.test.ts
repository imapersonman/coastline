...
const test_match = <Return>(n: string, ast: Ast, clauses: MatchClause<Return>[], no_matches: (() => Return) | undefined, out: Return) =>
...
test_match("1 clause no match", a, [match_clause(b, (u) => 2)], () => 1, 1)
test_match("1 clause match", a, [match_clause(a, (u) => 2)], () => 1, 2)
test_match("2 clause no match", a, [match_clause(b, (u) => 2), match_clause(c, (u) => 3)], () => 1, 1)
test_match("2 clause both match", X, [match_clause(b, (u) => 2), match_clause(c, (u) => 3)], () => 1, 2)
test_match("2 clause last match", c, [match_clause(b, (u) => 2), match_clause(c, (u) => 3)], () => 1, 3)
test_match("2 clause return unifier", a, [match_clause(X, (u) => u)], () => mk_default_substitution([]), mk_default_substitution([["X", a]]))