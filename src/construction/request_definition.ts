...
export interface RequestDefinition<Parameter, TransformedParameter, Response, TransformedResponse> {
    ...
    parameter: (p: Parameter | any) => TacticError | UserError | TransformedParameter
    response: (po: { p: Parameter, tp: TransformedParameter, r: Response | any }) => UserError | TransformedResponse
}
